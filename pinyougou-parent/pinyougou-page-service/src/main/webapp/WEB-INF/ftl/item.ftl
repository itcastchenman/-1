...
购热销商品</em>
					...
					<div class="clearfix choose">
						...
						<#list specificationList as item>
							...
							<#list item.attributeValue as p>
								<dd><a href="javascript:;"  class="{{isSelected(${item.attributeName},${p})?'selected':''}}"  ng-click="selectSpecification(${item.attributeName},${p})">${p}</a></dd>
							</#list>	
							</dl>
						</#list>
